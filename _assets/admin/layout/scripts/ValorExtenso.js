...
function Extenso() {
        ...
        this.interpret = function (numero) {
            ...
            if (numero.length < 2) {
                ...
                if (resposta === undefined) {
                    ...
                    if (unidade === 'undefined' || $.isEmptyObject(unidade)) {
                        resposta;
                    } else {
                        resposta += " e " + unidade;
                    }
        ...
        this.interpret = function (numero) {
            ...
            if (numero.length < 3) {
                ...
                if (this.left(numero, 3) === "100") {
                    ...
                    if (dezena === 'undefined' || $.isEmptyObject(dezena)) {
                        resposta;
                    } else {
                        resposta += " e " + dezena;
                    }
    ...
    this.interpret = function (numero) {
        ...
        return extensoParteInteira + Reais + (extensoParteInteira === "" ? "" : (extensoParteDecimal === "" ? "" : " e ")) + extensoParteDecimal + Centavos;
    };
